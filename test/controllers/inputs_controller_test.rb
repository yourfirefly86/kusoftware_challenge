...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { email: @input.email, firstname: @input.firstname, language: @input.language, lastname: @input.lastname, proficiency: @input.proficiency } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { email: @input.email, firstname: @input.firstname, language: @input.language, lastname: @input.lastname, proficiency: @input.proficiency } }
